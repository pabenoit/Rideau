...
class Motor
{
 public:
  ...
  Motor(int pin1, int pin2, std::function<int()> getThresholdFunc, std::function<int()> readCurrentFunc)
      : m_pin1(pin1), m_pin2(pin2), m_getThresholdFunc(getThresholdFunc), m_readCurrentFunc(readCurrentFunc)
  {
  }
